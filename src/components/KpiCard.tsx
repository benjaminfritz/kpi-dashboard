...
export const KpiCard: React.FC<KpiCardProps> = ({
  ...
  return (
    <div className={`relative overflow-hidden rounded-md bg-semantic-backgroundNeutral p-spacing-24 shadow-tokenShadow28 transition-transform duration-300 hover:-translate-y-0.5 dark:bg-neutral-85 ${outlineClasses} ${className}`}>
